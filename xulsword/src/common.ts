...
export function findBookNum(G: GType, bText: string | null): number | null {
  let retv = null;
...
export function getModuleLongType(G: GType, aModule: string): string | null {
...
export function getAvailableBooks(G: GType, version: string): string[] {

...
function Load() {
  updateCSSBasedOnCurrentLocale(["#dlg", "label, button"],0);
  ...
  try {var bundle = BUNDLESVC.createBundle("chrome://global/locale/commonDialogs.properties");}
  ...
  switch (Type) {
  case DLGALERT:
    imgSrc = "chrome://global/skin/icons/Warning.png";
    break;
  case DLGQUEST:
    imgSrc = "chrome://global/skin/icons/Question.png";
    break;
  case DLGINFO:
    imgSrc = "chrome://global/skin/icons/information-32.png";
    break;      
  }

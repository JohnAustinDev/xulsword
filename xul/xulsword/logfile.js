    ...
    if (aMessage) {
      ...
      if (isException) {
        ...
        try {
          ...
          file += "Vendor:" + appInfo.vendor + ", Name:" + appInfo.name + ", Version:" + appInfo.version + ", Build:" + appInfo.appBuildID + ", Xulrunner:" + appInfo.platformVersion + ", " + appInfo.platformBuildID + URLNEWLINE;
        }
        ...
        var bundle1 = BUNDLESVC.createBundle("chrome://global/locale/commonDialogs.properties");
        var bundle2 = BUNDLESVC.createBundle("chrome://global/locale/browser.properties");

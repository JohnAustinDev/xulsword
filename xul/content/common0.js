...
// generated by libxulsword. NOTE: the sr class may have multiple ";" separated Scripture
// references in its title, but only the first is matched.
const TextClasses = {
  ...
  dt:     [ { re:new RegExp(/^([^\.]+)\.([^\.]+)$/),                                  osistext:1,                         mod:2 } ],
  dtl:    [ { re:new RegExp(/^([^\.]+)\.([^\.]+)$/),                                  osistext:1,                         mod:2 } ],
  par:    [ { re:new RegExp(/^(\d+)\.([^\.]+)$/),                                          par:1,                         mod:2 } ],

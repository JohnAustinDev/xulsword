//@line 40 "e:\builds\moz2_slave\mozilla-1.9.1-win32-xulrunner\build\toolkit\components\printing\content\printPageSetup.js"
...
/*    var ok = prompter.prompt(window, title, promptText, result, null, { value: false } );
    ...
    var dlg = window.openDialog("chrome://xulsword/content/dialog.xul", "dlg", DLGSTD, result, 
        ...
        null,
        promptText);
    if (result.ok) {node.custom = result.value;}

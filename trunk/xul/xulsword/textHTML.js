...
function getScriptBoxHeader(myBook, myChap, version, showBookName, showIntroduction, showOriginal) {
  ...
  if (!showOriginal) {
    ...
    mtext += "<div class=\"audiolink\"><img name=\"listenlink\" id=\"listenlink." + myChap + "\" src=\"chrome://xulsword/skin/images/listen0.png\" style=\"visibility:hidden;\" onmouseover=\"scriptboxMouseOver(event)\" onmouseout=\"scriptboxMouseOut(event)\"></div>";
    mtext += "<br><br>";

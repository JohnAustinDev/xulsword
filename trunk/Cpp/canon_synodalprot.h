/******************************************************************************
 * canon_synodalprot.h - Versification data for the Synodal Protestant system
 *
...
// This versification data is similar to that of the Synodal verse system, but without the following apocryphal books, verses and chapters:
//    books: PrMan 1Esd Tob Jdt Wis Sir EpJer Bar 1Macc 2Macc 3Macc 2Esd
//    chapters: Ps 151, Dan 13, Dan 14
//    verses: Josh 24:34-36, Prov 4:28-29, Prov 13:26, Prov 18:25, Dan 3:34-100
// Compared to the Synodal system, there is also one additional verse: Ps 114:9 (perhaps this verse should also be included in the Synodal system?)


#ifndef CANON_SYNODLAPROT_H
#define CANON_SYNODLAPROT_H
...
int vm_synodalprot[] = {
  ...
  // Numbers
  54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 15, 34, 45, 41, 50, 13, 32, 22,
    29, 35, 41, 30, 25, 18, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13,
  // Deuteronomy
  46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 18, 29, 23, 22, 20, 22, 21,
    20, 23, 30, 25, 22, 19, 19, 26, 68, 29, 20, 30, 52, 29, 12,
  // Joshua
  18, 24, 17, 24, 16, 26, 26, 35, 27, 43, 23, 24, 33, 15, 63, 10, 18, 28, 51,
    9, 45, 34, 16, 33,
  // Judges
  ...
  28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24,
    43, 15, 23, 28, 23, 44, 25, 12, 25, 11, 31, 13,
  // II Samuel
  ...
  6, 12, 9, 9, 13, 11, 18, 10, 39, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14,
    ...
    9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13,
    20, 17, 8, 19, 13, 14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9,
    5, 8, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10, 9, 26, 9, 10, 2, 29, 176,
    7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 7,
  ...
  51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42,
    31, 25,
  // Acts
  26, 47, 26, 37, 42, 15, 60, 40, 43, 48, 30, 25, 52, 28, 41, 40, 34, 28, 40,

  ...
  'targets': [
    {
      ...
      'target_conditions': [['OS=="win"', {
        'actions': [{
          ...
          'outputs': ['$(LIBXULSWORD)/lib/libxulsword.lib'],
          'action': ['lib', "/def:$(LIBXULSWORD)/lib/libxulsword.def", '/machine:$(WINMACHINE)', '/out:$(LIBXULSWORD)/lib/libxulsword.lib'],
        }],
      }]],
    },
    {
      ...
      'target_conditions': [
        ...
        ['OS=="win"', { 'libraries': ['$(LIBXULSWORD)/lib/libxulsword.lib']}]],
      }
    ],
  'variables' : {
    'openssl_fips': ''
